...
/*Program to have the user enter a date using digits and slashes
allowing for the fact that user may not use 0 in their entry then displays
date and/or error code and calculates what day of the year this date falls on*/
import java.util.*;
import javax.swing.*;
...
class Untitled {
	public static void main(String[] args) {
		...
		//Calculates if too many days have been 
